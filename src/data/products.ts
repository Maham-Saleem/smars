...
export const collections = [
  { id: "Signature", name: "Signature Collection", description: "Timeless elegance for the discerning", image: img.collection, count: 4 },
  { id: "Floral", name: "Floral Collection", description: "Nature's finest blossoms captured", image: img.flatLay, count: 3 },
  { id: "Oud", name: "Oud Collection", description: "Rare and precious wood essences", image: img.chain, count: 3 },
  { id: "Limited Edition", name: "Limited Edition", description: "Exclusive creations, limited in number", image: img.elegant, count: 2 },
];
