      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="mt-10 flex flex-col sm:flex-row gap-4 max-w-lg mx-auto">
            ...
            <button
              type="submit"
              className="px-8 py-4 bg-dark-brown text-cream text-sm tracking-[0.2em] uppercase font-medium hover:bg-champagne-gold hover:text-deep-coffee transition-all duration-300 rounded-lg whitespace-nowrap"
            >
              Subscribe
            </button>
          </form>
